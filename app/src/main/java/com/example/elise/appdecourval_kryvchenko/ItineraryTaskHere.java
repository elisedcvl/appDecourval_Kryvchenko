 ...
 */
public class ItineraryTaskHere extends AsyncTask<Void, Integer, Boolean> {
     ...
     * @param editArrival
     */
    public ItineraryTaskHere(final Context context, final GoogleMap gMap, final double latDeparture, final double lngDeparture, final String editArrival) {
        this.context = context;
        this.gMap= gMap;
        this.latDeparture = latDeparture;
        this.lngDeparture = lngDeparture;
    ...
    protected Boolean doInBackground(Void... params) {
        try {
            ...
            url.append("&origin=");
            url.append(latDeparture + "," + lngDeparture);
